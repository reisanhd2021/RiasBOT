...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: '*Perintah Hanya Untuk Owner Ku*', 
    owner: '*Perintah Hanya Untuk Owner Ku*',
    mods: 'Perintah Hanya Untuk Moderator!',
    premium: 'Perintah ini hanya untuk pengguna  _*Premium*_',
    group: '*Perintah Ini Hanya Untuk Di Grup*',
    private: '*Perintah Ini Hanya Untuk Chat Pribadi*',
    admin: '*Perintah Ini Hanya Untuk Admin Grup*',
    botAdmin: 'Bot Harus Admin!',
    vip: 'Perintah Ini Hanya Untuk Pengguna *Vip*',
