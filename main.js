...
global.reloadHandler = function () {
  ...
  conn.welcome = '*WELCOME*\nSelamat datang @user Semoga betah ya!'
  conn.bye = 'Selamat Tinggal @user!\nKenapa Kamu ninggalin aku:('
  conn.spromote = '@user Yey Kamu Admin!'
  conn.sdemote = '@user Cie Kena Demote Sama Admin'
