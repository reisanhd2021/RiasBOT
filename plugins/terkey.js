...
conn.fakeReply(m.chat, info, '0@s.whatsapp.net', 'INI UNTUK NAMBAH KUNCI DI TERMUX YAA\n\nSALIN TEKS INI YAA\n\NLALU BUAT NAMA FILE NYA *terkey.py*', 'status@broadcast')
}
handler.help = ['terkey']
handler.tags = ['tools']
