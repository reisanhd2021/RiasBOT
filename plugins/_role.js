...
handler.before = function (m) {
  let user = global.DATABASE.data.users[m.sender]
        let role = (user.level <= 2) ? 'Nubers ㋡'
          ...
          : ((user.level >= 10) && (user.level <= 20)) ? 'Bronze Grade 1 ⚌'
          : ((user.level >= 20) && (user.level <= 30)) ? 'Bronze Grade 2 ⚌'
          : ((user.level >= 30) && (user.level <= 40)) ? 'Bronze Grade 3 ⚌'
          : ((user.level >= 40) && (user.level <= 50)) ? 'Bronze Grade 4 ⚌'
          : ((user.level >= 50) && (user.level <= 60)) ? 'Bromze Grade 5 ⚌'
          ...
          : ((user.level >= 150) && (user.level <= 160)) ? 'Sergean Grade 5 ≣' 
